...
export default function Hipodrom() {
  ...
  const [ammount, setAmmount] = useState<any>(0);
  ...
  const socketInitializer = () => {
    ...
    socket.on('horse3Orana', (data: any) => {
      setHorse3Oran(data);
    });
    socket.on('horse4Orana', (data: any) => {
      setHorse4Oran(data);
    });
    socket.on('horse5Orana', (data: any) => {
      setHorse5Oran(data);
    });
  };
