...
//   const ethChainId =
//     process.env.NEXT_PUBLIC_NETWORK === 'testnet' ? '0x61' : '0x38';
...
//         setNetwork(true);
//         setNetworkName(
//           process.env.NEXT_PUBLIC_NETWORK === 'testnet' ? 'BSC Testnet' : 'BSC'
//         );
//       }
//     } catch (error) {}
//   };
...
//     if (user) {
//       let miktar = (document.getElementById('swapToCoin') as HTMLInputElement)
//         .value;
//       setWaiting(true);
//       if (miktar == '0') {
//         setErrMsgSnackbar('Please enter a value greater than 0');
...
//     if (user) {
//       let miktar = (document.getElementById('swapToMatic') as HTMLInputElement)
//         .value;
//       setWaiting(true);
//       if (miktar == '0') {
//         setErrMsgSnackbar('Please enter a value greater than 0');
...
//       ) : null}
//       {waiting ? (
//         <div className="flex absolute min-w-full min-h-full bg-black/70 justify-center items-center ">
//           please wait...
//         </div>
//       ) : null}
...
//             {' '}
//             {user.maticBalance.toString().slice(0, 6)} Matic{' '}
//           </span>
//           in your account
//         </p>
...
//                 settings?.requestType === 'Matic' ? 'MATIC' : Coin.name
//               })`}</span>{' '}
//             </h4>
//             <input
//               type="number"
...
//             <p className="text-xs ">
//               {' '}
//               1 MATIC = x{Coin.katSayi} {Coin.name}{' '}
//             </p>
//             <input
//               type="number"
//               placeholder="Type here"
...
//             <p className="text-xs ">
//               {' '}
//               1 {Coin.katSayi} {Coin.name} = 1/{Coin.katSayi} MATIC{' '}
//             </p>
//             <input
//               type="number"
//               placeholder="Type here"
