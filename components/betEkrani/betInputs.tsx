      ...
      <div className="flex flex-col items-center justify-center gap-5 w-full lg:w-2/3 ">
        ...
        <div
          ...
          <button
            ...
            className="absolute right-5 z-10 btn btn-xs btn-outline border-gray-700">
            Clear
          </button>
        </div>
        ...
        <div className="grid grid-cols-4 content-center md:flex w-full gap-3 items-center justify-center text-white">
          ...
          {/* {user && (
            <button
              ...
              className="btn btn-circle hidden md:block bg-[url(/cion.webp)] bg-contain bg-center bg-no-repeat text-black border">
              {' '}
              Max{' '}
            </button>
          )} */}
        ...
        <div className="flex flex-col md:flex-row items-center justify-center w-full md:justify-around gap-3">
          <button
            onClick={() => {
              setSecilenAt(Horses.Horse1);
            }}
            className={`btn hidden md:block border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${
              secilenAt === Horses.Horse1
                ? 'bg=[#333541]'
                : secilenAt === 0
                ? 'bg=[#333541]'
                : 'btn-ghost'
          ...
          <button
            onClick={() => {
              setSecilenAt(Horses.Horse2);
            }}
            className={`btn hidden md:block border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${
              secilenAt === Horses.Horse2
                ? 'bg=[#333541]'
                : secilenAt === 0
                ? 'bg=[#333541]'
                : 'btn-ghost'
          ...
          <div className="space-x-10 md:hidden">
            <button
              ...
              className={`btn border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${
                secilenAt === Horses.Horse1
                  ? 'bg=[#333541]'
                  : secilenAt === 0
                  ? 'bg=[#333541]'
          ...
          <button
            onClick={() => {
              setSecilenAt(Horses.Horse3);
            }}
            className={`btn hidden md:block border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${
              secilenAt === Horses.Horse3
                ? 'bg=[#333541]'
                : secilenAt === 0
                ? 'bg=[#333541]'
                : 'btn-ghost'
          ...
          <button
            onClick={() => {
              setSecilenAt(Horses.Horse4);
            }}
            className={`btn hidden md:block border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${
              secilenAt === Horses.Horse4
                ? 'bg=[#333541]'
                : secilenAt === 0
                ? 'bg=[#333541]'
                : 'btn-ghost'
          ...
          <button
            onClick={() => {
              setSecilenAt(Horses.Horse5);
            }}
            className={`btn border text-center border-white text-white p-1 btn-circle bg=[#333541] btn-xl w-20 h-20 ${
              secilenAt === Horses.Horse5
                ? 'bg=[#333541]'
                : secilenAt === 0
                ? 'bg=[#333541]'
                : 'btn-ghost'
