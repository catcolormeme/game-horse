    ...
    <>
      ...
      <div className="hidden lg:flex items-center justify-center w-full h-20 bg-[#24252F] sticky top-0 z-50 ">
        <div className="flex flex-col gap-3 items-center justify-center w-[250px] absolute top-0 bg-[#24252F] rounded-lg h-full z-50  ">
          ...
          <div className=" font-normal text-xs text-gray-200 tracking-widest">
            Change Your Life
          </div>
        </div>
          ...
          <div className="flex w-full bg-[#16181F] text-[11px] h-[30px] relative ">
            <div className="marquee-container relative w-full">
              <div className="marquee ">
                <span>
                  CatColor on the BSC Network is an exciting horse racing game
                  where players compete to be the best virtual jockeys. Choose
                  your horse and place bets on the races. With captivating
                  graphics and smooth gameplay, get ready for the thrill of the
                  tracks at full gallop!
                </span>
              </div>
