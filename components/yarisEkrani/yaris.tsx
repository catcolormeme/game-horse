    ...
    <div className="min-w-full min-h-screen items-center overflow-x-hidden ">
      ...
      <div className="flex flex-row">
        <div
          ...
          {/* //? Finish line */}
          <div
            className={`absolute h-2/3 w-4  bg-[url(/finish.png)] top-1/3 duration-1000 transition-all ease-linear ${
          ...
          <div className="flex md:h-44 w-full items-center justify-center relative">
            <div
              ...
              className="absolute right-0 md:right-10 flex flex-col text-center items-center justify-center fill-gray-200 text-gray-200">
              {soundStatus ? (
                <>
                  {' '}
                  <BsFillVolumeUpFill className="w-8 h-8" /> Sound On{' '}
                </>
              ) : (
                <>
                  {' '}
                  <BsFillVolumeMuteFill className="w-8 h-8" /> Sound Off
                </>
              )}
            </div>
                ...
                {horses
                  ...
                  .map((horse: any, index: number) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="md:h-32 w-full xl:w-1/5 md:border-[2px] p-2 rounded-md flex-col flex">
          ...
          <div
            ...
            className="w-full h-14 mt-8"></div>
